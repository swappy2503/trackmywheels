            ...
            <div class="col-lg-12">
                ...
                <table align="center">
                        <tr>
                            <td>
                            <h4>
                            2. Identify the inconsistent figure from the following  ?
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <img src="img/data/2/1.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/>
                                            
                                        </div>
                                   
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="2" />
                                            <img src="img/data/2/2.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/>
                                        </div>
                                       ...
                                       <div class="form-check">
                                            ...
                                            <img src="img/data/2/3.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/>
                                        </div>
                                    
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="4" />
                                            <img src="img/data/2/4.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/>
                                        </div>
                                    </td>
                                </tr>
