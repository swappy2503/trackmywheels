            ...
            <div class="col-lg-12">
                <form method="post" action="db/cData.php" class="customRadio">
                    <table align="center">
                        ...
                        <tr><td><h3>2. How is the campaign being encouraged among people?</h3></td></tr>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label">through Radio, T.V. and films</label>
                                        </div>
                                   
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="2" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">through Gram Panchayats</label>
                                        </div>
                                       ...
                                       <div class="form-check">
                                        ...
                                        <input type="hidden" name="quesNo" value="2" />
                                            ...
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">through various agencies</label>
                                        </div>
