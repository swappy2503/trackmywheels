            ...
            <div class="col-lg-12">
                <form method="post" action="db/arData.php" class="customRadio">
                    <table align="center">
                        <tr>
                            <td>
                                <h3> 9.	If  ICI=<img src="img/abstract/9/q.png" class="img-rounded" alt="Cinque Terre" /> Then ICCI= ? <br /></h3>
                            </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <img src="img/abstract/9/1.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/> 
                                        </div>
                                   
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="2" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <img src="img/abstract/9/2.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/> 
                                        </div>

                                        
                                       <div class="form-check">
                                        <input type="hidden" name="uname" value="<?php echo $uname; ?>"/>
                                        <input type="hidden" name="quesNo" value="9" />
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="3" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <img src="img/abstract/9/3.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/> 
                                        </div>
                                    
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="4" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <img src="img/abstract/9/4.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/> 
                                        </div>
                                    </td>
                                </tr>
