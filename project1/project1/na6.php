            ...
            <div class="col-lg-12">
                ...
                <table align="center">
                        <tr>
                            <td>
                            <h4>
                            6.	Choose the correct number in place  the question mark from the following ?
                              <br />      75,    ? ,    45  , 33  , 23  , 15  , 9 ,   5
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label">57</label>
                                        </div>
                                       ...
                                       <div class="form-check">
                                            ...
                                            <label class="form-check-label">59</label>
                                        </div>
