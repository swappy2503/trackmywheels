            ...
            <div class="col-lg-12">
                <form method="post" action="db/arData.php" class="customRadio">
                    <table align="center">
                        <tr>
                            <td>
                                <h3> 2.	Choose the correct figure in place of the question mark from the following?. <br /><img src="img/abstract/2/q.png" class="img-rounded" alt="Cinque Terre" id="quesImg"/> </h3>
                            </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <img src="img/abstract/2/1.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/> 
                                        </div>
                                   
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="2" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <img src="img/abstract/2/2.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/> 
                                        </div>
                                       ...
                                       <div class="form-check">
                                        ...
                                        <input type="hidden" name="quesNo" value="2" />
                                            ...
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <img src="img/abstract/2/3.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/> 
                                        </div>
                                    
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="4" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <img src="img/abstract/2/4.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/> 
                                        </div>
                                    </td>
                                </tr>
