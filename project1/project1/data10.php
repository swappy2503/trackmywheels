            ...
            <div class="col-lg-12">
                ...
                <table align="center">
                        <tr>
                            <td>
                            <h4>
                                10. How many boys are there who are not players?
                            
                            <br /> <img src="img/data/7/q.png" class="img-rounded" alt="Cinque Terre" id="quesImg"/>
                                ...
                                <tr>
                                    <td>
                                       ...
                                       <div class="form-check">
                                            ...
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="15" />
