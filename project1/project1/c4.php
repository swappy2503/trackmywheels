            ...
            <div class="col-lg-12">
                <form method="post" action="db/cData.php" class="customRadio">
                    <table align="center">
                        ...
                        <tr>
                        <td><h3>4. How is the government helping for construction of toilets?</h3></td>
                        </tr>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label">by giving loans to agencies</label>
                                        </div>
                                   
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="2" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">by asking people to collect money to construct toilets</label>
                                        </div>
                                       ...
                                       <div class="form-check">
                                        ...
                                        <input type="hidden" name="quesNo" value="4" />
                                            ...
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">by constructing toilet by the government itself</label>
                                        </div>
                                    
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="4" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">by sanctioning financial grants.</label>
                                        </div>
                                    </td>
                                </tr>
