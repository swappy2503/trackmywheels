            ...
            <div class="col-lg-12">
                ...
                <table align="center">
                        <tr>
                            <td>
                            <h4>
                                9. Choose the correct number in place the question mark from the following?
                            
                            <br /> <img src="img/numerical/9/q.png"  class="img-rounded" alt="Cinque Terre" id="quesImg"/>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label">124</label>
                                        </div>
                                       ...
                                       <div class="form-check">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label">68</label>
                                        </div>
                                    </td>
                                </tr>
