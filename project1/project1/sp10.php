            ...
            <div class="col-lg-12">
                <form method="post" action="db/spData.php" class="customRadio">
                    <table align="center">
                        <tr>
                            <td>
                                <h3> 10. Which option shows the mirror reflection of following figure? <br /><img src="img/spatial/10/q.png" class="img-rounded" alt="Cinque Terre" /> </h3>
                            </td>
