...
#quesImg{
    ...
    <div class="container">
        <div class="row">
            ...
            <h1 class="mt-5">Data Interpretation Ability</h1>
                <br/>
                <br/>
            </div>
    </div>
            <div class="col-lg-12">
                <form method="post" action="db/diaData.php" class="customRadio">
                <table align="center">
                        <tr>
                            <td>
                            <h4>
                                1. Which of the following figure 12/60 represents the equivalent fraction ?
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <img src="img/data/1/1.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/>
                                            
                                        </div>
                                   
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="2" />
                                            <img src="img/data/1/2.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/>
                                        </div>
                                       ...
                                       <div class="form-check">
                                            ...
                                            <img src="img/data/1/3.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/>
                                        </div>
                                    
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="4" />
                                            <img src="img/data/1/4.png" class="img-rounded" alt="Cinque Terre" id="ansImg"/>
                                        </div>
                                    </td>
                                </tr>
