            ...
            <div class="col-lg-12">
                <form method="post" action="db/cData.php" class="customRadio">
                    <table align="center">
                        ...
                        <tr>
                        <td><h3>7. Who suffers the most while going for toilet during day time?</h3></td>
                        </tr>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label">all the people in the country</label>
                                        </div>
                                   
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="2" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">only women in villages & towns.</label>
                                        </div>
                                       ...
                                       <div class="form-check">
                                        ...
                                        <input type="hidden" name="quesNo" value="7" />
                                            ...
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">la sick Persons, especially ladies</label>
                                        </div>
                                    
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="4" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">children of small poor colonies</label>
                                        </div>
                                    </td>
                                </tr>
