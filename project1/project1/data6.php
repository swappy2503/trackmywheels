            ...
            <div class="col-lg-12">
                ...
                <table align="center">
                        <tr>
                            <td>
                            <h4>
                                6. How many part is shaded considering the portion of both figure?
                            
                            <br /> <img src="img/data/6/q.png" class="img-rounded" alt="Cinque Terre" id="quesImg"/>
                                    ...
                                    <td>
                                       ...
                                       <div class="form-check">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label">4/8</label>
                                        </div>
                                    </td>
                                </tr>
