...
#quesImg{
    ...
    <div class="container">
        <div class="row">
            ...
            <h1 class="mt-5">Observational Ability</h1>
                <br/>
                <br/>
            </div>
    </div>
            <div class="col-lg-12">
                <form method="post" action="db/opData.php" class="customRadio">
                <table align="center">
                        <tr>
                            <td>
                                <h3> 8.	The maximum number of difference in the figure are? <br /><img src="img/observability/8/q.png" class="img-rounded" alt="Cinque Terre" id="quesImg" />
