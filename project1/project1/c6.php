            ...
            <div class="col-lg-12">
                <form method="post" action="db/cData.php" class="customRadio">
                    <table align="center">
                        ...
                        <tr>
                        <td><h3>6. “Toilet” a movie depicts the problems of:</h3></td>
                        </tr>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label">People of the villages and towns for toilet.</label>
                                        </div>
                                   
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="2" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">Women facing difficulties while going for toilet...</label>
                                        </div>
                                       ...
                                       <div class="form-check">
                                        ...
                                        <input type="hidden" name="quesNo" value="6" />
                                            ...
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">Women-folk as how they are compelled to go for toilet before the sun rise or after the sun set.</label>
                                        </div>
                                    
                                        <div class="form-check">
                                            <input type="radio" required title="Please select this option" name="ans" id="ans" class="form-check-input" value="4" />
                                            <!--<label class="form-check-label" for="<?php echo $result['ans']; ?>"><?php echo $result['ans']; ?></label>-->
                                            <label class="form-check-label">People of inhabitants of backward area for toilet.</label>
                                        </div>
                                    </td>
                                </tr>
